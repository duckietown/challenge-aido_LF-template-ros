...
## Template "ROS" for challenge [`aido_LF`][lf], [`aido_LFV`][lfv] and [`aido_LFVI`][lfvi]
...
[This code is documented here](https://docs.duckietown.org/daffy/AIDO/out/ros_template.html).
